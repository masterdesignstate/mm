...
export default function Login({ status, canResetPassword, showLogin = false }) {
    ...
    const submit = (e) => {
        ...
        post(route("login"), {
            ...
            //         window.location.href = '/admin'; // Redirect to Filament
            //     } else {
            //         window.location.href = '/my-profile'; // Redirect normal users
            //     }
            // }
        });
    };
    ...
    if (!showForm)
        return (
            <GuestLayout>
                ...
                <div className="flex flex-col items-center px-4 my-8 lg:my-0">
                    <div>
                        <h1 className="mb-8 px-2 text-center font-head text-6xl font-medium uppercase">
                            Love is a Formula – <br />
                            Start Solving Yours Today!
                        </h1>
                    </div>

                    <div className="max-w-96 w-[90%] lg:w-96 mx-auto px-4">
                        <button
                        ...
                        <div className="relative my-8">
                            <span className="absolute left-1/2 top-0 -mt-3 w-10 -translate-x-1/2 bg-white dark:bg-bc-900 text-center">
                                Or
                            </span>
        ...
        return (
            <GuestLayout>
                ...
                <h1 className="mb-4 text-center text-4xl font-bold uppercase">
                    Login
                </h1>
                <div className="h-2 w-96"></div>

                <form onSubmit={submit} className=" max-w-96 w-[90%] lg:w-96 mx-auto px-4">
