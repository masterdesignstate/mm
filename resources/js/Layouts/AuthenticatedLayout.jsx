...
import {SheetContent, SheetDescription, SheetHeader, SheetTitle, SheetTrigger, Sheet} from "@/Components/ui/sheet.jsx";
...
export default function AuthenticatedLayout({header, children}) {
    ...
    return (
        <div className="min-h-screen  bg-repeat" style={{backgroundImage: `url(${grid})`}}>
                            ...
                            <div className="relative flex">
                                <Sheet>
                                    <SheetTrigger>
                                        ...
                                        <div className="border rounded-full border-bpurple-500  p-2 relative"
                                             onClick={() => setShowingNavigationDropdown(!showingNavigationDropdown)}
                                        >
                                            <Notification02Icon className="text-bpurple-500"/>
                                            <div
                                    ...
                                    <SheetContent className="w-[400px] sm:w-[540px]">
                                        <SheetHeader>
                                            ...
                                            <SheetDescription>
                                                All the important notifications for your profile will appear here.
                                            </SheetDescription>
                                        </SheetHeader>
                                    </SheetContent>
                                </Sheet>
