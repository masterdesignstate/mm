  ...
  if (!showForm)
    return /* @__PURE__ */ jsxs(GuestLayout, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center ", children: [
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("h1", { className: "text-4xl font-bold text-center uppercase mb-8 px-2", children: [
          "Love is a Formula – ",
          /* @__PURE__ */ jsx("br", {}),
          "Start Solving Yours Today!"
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "w-96", children: [
          /* @__PURE__ */ jsx("button", { className: "bg-bpurple-500 text-white w-full py-4 rounded-full", onClick: () => setShowForm(true), children: "Login with Email" }),
          /* @__PURE__ */ jsxs("div", { className: "text-center my-4", children: [
            "Don’t have an account?",
            /* @__PURE__ */ jsx(Link, { href: route("register"), className: "ml-2 text-pink-400", children: "Sign Up" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "my-8 relative", children: [
            /* @__PURE__ */ jsx("span", { className: "bg-white top-0 -mt-3 left-1/2 -translate-x-1/2 absolute w-10 text-center", children: "Or" }),
            /* @__PURE__ */ jsx("hr", { className: " border-gray-400" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("a", { href: route("facebook.auth"), className: "bg-[#1877F2] text-white w-full py-4 rounded-full flex items-center justify-center space-x-4", children: [
              /* @__PURE__ */ jsxs(
                "svg",
                {
                  width: "24",
                  ...
                  children: [
                    /* @__PURE__ */ jsx("rect", { width: "24", height: "24", transform: "translate(0 0.5)", fill: "#1877F2" }),
                    /* @__PURE__ */ jsx(
                      "path",
                      {
                ...
                children: [
                  /* @__PURE__ */ jsxs(
                    "svg",
                    {
                      ...
                      xmlns: "http://www.w3.org/2000/svg",
                      children: [
                        /* @__PURE__ */ jsx("rect", { width: "24", height: "24", transform: "translate(0.5)", fill: "white" }),
                        /* @__PURE__ */ jsx(
                          "path",
                          {
                            fillRule: "evenodd",
    ...
    return /* @__PURE__ */ jsxs(GuestLayout, { children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-4xl mb-4 font-bold text-center uppercase", children: "Login" }),
      /* @__PURE__ */ jsx("div", { className: "w-96 h-2" }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "w-full", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-4 flex items-center justify-end", children: /* @__PURE__ */ jsx("button", { className: "bg-bpurple-500 text-white w-full py-4 rounded-full", disabled: processing, children: "Login" }) })
      ] })
    ] });
}
export {
