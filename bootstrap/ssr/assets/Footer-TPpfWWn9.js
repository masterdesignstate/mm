...
const Footer = () => {
  ...
  if (user)
    return /* @__PURE__ */ jsxs("footer", { className: "text-center mt-16", children: [
      /* @__PURE__ */ jsx("hr", {}),
      /* @__PURE__ */ jsx("div", { className: "text-center py-4 px-4 text-sm", children: "© Copyright 2025. All Rights Reserved." })
    ] });
  else
